...
CREATE TABLE licence (
  ...
  probation_area_code varchar(20),
  probation_area_description varchar(60),
  probation_pdu_code varchar(20),
  probation_pdu_description varchar(60),
  probation_lau_code varchar(20),
  probation_lau_description varchar(60),
  probation_team_code varchar(20),
  probation_team_description varchar(60),
