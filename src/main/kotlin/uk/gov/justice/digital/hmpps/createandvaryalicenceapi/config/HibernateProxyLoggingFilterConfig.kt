...
private val STATE_PACKAGE = "org.hibernate.engine.internal.StatefulPersistenceContext"
...
@Configuration
class HibernateProxyLoggingFilterConfig {

  @PostConstruct
  fun attachFilterToAllAppenders() {
    val loggerContext = LoggerFactory.getILoggerFactory() as LoggerContext
    val rootLogger = loggerContext.getLogger(org.slf4j.Logger.ROOT_LOGGER_NAME)

    // added for all appenders (Console, ApplicationInsightsAppender .. )
    rootLogger.iteratorForAppenders().forEach { appender ->
      appender.addFilter(HibernateProxyLoggingFilter())
    }
  }
