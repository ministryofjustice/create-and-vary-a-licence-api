...
class PromptComController(
  ...
  @PostMapping(value = ["/prompt-com"])
  @PreAuthorize("hasAnyRole('CVL_ADMIN')")
  @Operation(
    summary = "Triggers the prompt COM job.",
    description = "Triggers a job that send emails to COMs to encourage them to progress cases. Requires ROLE_CVL_ADMIN.",
