...
class LicenceController(private val licenceService: LicenceService, private val sentenceDateService: SentenceDateService) {
  ...
  fun updateSentenceDates(
    ...
    sentenceDateService.updateSentenceDates(licenceId, request)
  }
}
