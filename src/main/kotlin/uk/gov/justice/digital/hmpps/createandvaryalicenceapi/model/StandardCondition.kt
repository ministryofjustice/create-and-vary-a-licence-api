...
data class StandardCondition(
  ...
  @field:Schema(description = "The internal ID for this standard condition on this licence", example = "98987")
  val id: Long,
  ...
  @field:Schema(description = "The sequence of this standard condition", example = "1")
  val sequence: Int,
