...
data class LicenceEvent(
  @field:Schema(description = "The internal ID of the licence event", example = "1234")
  val id: Long,
  ...
  @field:Schema(description = "The licence event type", example = "LicenceEventType.VARIATION_SUBMITTED")
