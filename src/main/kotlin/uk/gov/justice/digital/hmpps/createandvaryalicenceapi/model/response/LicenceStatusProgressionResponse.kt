...
@Schema(description = "Response representing a case tracking licence status progression")
data class LicenceStatusProgressionResponse(
  ...
  @field:Schema(description = "The prison for the case", example = "Moorland (HMP & YOI)")
  val prison: String?,
