...
enum class RemandCourtEvents(val code: String, val description: String) {
  ...
  COMMIT_TRANSFER_SEND_TO_CROWN_COURT_FOR_TRIAL_IN_CUSTODY("4560", "Commit/Transfer/Send to Crown Court for Trial in Custody"),
  COMMIT_TRANSFER_SEND_TO_CROWN_COURT_FOR_TRIAL_IN_CUSTODY_WITH_DIRECTION_TO_BAIL("4561", "Commit/Transfer/Send to Crown Court for Trial in Custody With Direction to Bail"),
  COMMIT_TRANSFER_SEND_TO_CROWN_COURT_FOR_TRIAL_IN_SECURE_LOCAL_AUTHORITY_ACCOMMODATION("4563", "Commit/Transfer/Send to Crown Court for Trial in Secure Local Authority Accommodation"),
  COMMIT_TRANSFER_SEND_TO_CROWN_COURT_FOR_TRIAL_IN_CUSTODY_TRANSFER_DIRECTION("4564", "Commit/Transfer/Send to Crown Court for Trial in Custody (Transfer Direction)"),
  COMMIT_TO_CROWN_COURT_FOR_TRIAL_SUMMARY_EITHER_WAY_OFFENCES("4565", "Commit to Crown Court for Trial (Summary / Either Way Offences)"),
  MENTAL_HEALTH_COMMIT_TO_CROWN_COURT_FOR_RESTRICTION_REMAND_TO_HOSPITAL("4570", "Mental Health Commit to Crown Court for Restriction (Remand to Hospital)"),
  MENTAL_HEALTH_COMMIT_TO_CROWN_COURT_FOR_RESTRICTION_REMAND_TO_PRISON("4571", "Mental Health Commit to Crown Court for Restriction (Remand to Prison)"),
