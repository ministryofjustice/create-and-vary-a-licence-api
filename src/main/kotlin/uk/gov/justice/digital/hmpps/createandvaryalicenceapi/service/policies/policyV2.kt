  ...
  additionalConditions = AdditionalConditions(
    ap = listOf(
      ...
      AdditionalConditionAp(
        ...
        inputs = listOf(
          Input(
            ...
            options = listOf(
              ...
              Option("sexual offending"),
              Option("violent offending"),
              Option("prolific offending"),
        ...
        requiresInput = true,
        text = "To comply with any requirements specified by your supervising officer for the purpose of ensuring that you address your [ALCOHOL/DRUG/ANGER/GAMBLING/DEBT/SOLVENT ABUSE/SEXUAL OFFENDING/VIOLENT OFFENDING/PROLIFIC OFFENDING/OFFENDING BEHAVIOUR] problems at the [NAME OF COURSE / CENTRE].",
