  ...
  standardConditions = StandardConditions(
    standardConditionsAp = listOf(
      StandardConditionAp(
        ...
        text = "Behave well and do not commit any crime.",
      ),
      StandardConditionAp(
        code = "3b19fdb0-4ca3-4615-9fdd-61fabc1587af",
        text = "Live at an address agreed by your supervising officer.",
      ),
      StandardConditionAp(
        code = "3361683a-504a-4357-ae22-6aa01b370b4a",
        text = "Ask your supervising officer if you want to stay at a different address for one or more nights.",
      ),
      StandardConditionAp(
      ...
      StandardConditionAp(
        ...
        text = "Tell your supervising officer about any new work you want to do. Get their approval before you start this work.",
      ),
      StandardConditionAp(
        code = "88069445-08cb-4f16-915f-5a162d085c26",
        text = "Get permission from your supervising officer if you want to leave the UK, Isle of Man or Channel Islands. This does not apply if you are being deported or removed for immigration purposes.",
      ),
      StandardConditionAp(
        code = "7d416906-0e94-4fde-ae86-8339d339ccb7",
        text = "Give your passport to your supervising officer and speak to them before applying for a new passport.",
      ),
      StandardConditionAp(
