...
data class AdditionalConditionUploadSummary(
  @field:Schema(description = "The internal ID of this upload for this condition on this licence", example = "98989")
  val id: Long = -1,
  ...
  @field:Schema(description = "The file type uploaded for this condition on this licence", example = "application/pdf")
