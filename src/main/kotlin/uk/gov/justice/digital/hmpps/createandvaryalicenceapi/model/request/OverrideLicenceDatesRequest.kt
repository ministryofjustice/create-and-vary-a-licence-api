...
data class OverrideLicenceDatesRequest(
  ...
  val updatedLicenceKind: LicenceKind,

  @field:Schema(description = "The updated eligible kind based on the current dates", example = "FIXED_TERM")
  val updatedEligibleKind: EligibleKind,
