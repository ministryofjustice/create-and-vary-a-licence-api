...
class TimeServedController(
  ...
  companion object {
    private val log = LoggerFactory.getLogger(TimeServedController::class.java)
  }

  @PutMapping("/time-served/external-records/{nomsId}/{bookingId}")
  @PreAuthorize("hasAnyRole('CVL_ADMIN')")
  @Operation(
    summary = "Creates or updates a Time Served External Record.",
    description = "Creates or updates a Time Served External Record Reason. Requires ROLE_CVL_ADMIN.",
    security = [SecurityRequirement(name = "ROLE_CVL_ADMIN")],
  )
  @ApiResponses(
    value = [
      ApiResponse(responseCode = "200", description = "Licence created or updated successfully"),
      ApiResponse(
        responseCode = "400",
  ...
  @GetMapping(
    value = ["/time-served/external-records/{nomsId}/{bookingId}"],
  ...
  @PutMapping("/licences/time-served/{licenceId}/confirm/probation-contact")
  @PreAuthorize("hasAnyRole('CVL_ADMIN')")
  @Operation(
