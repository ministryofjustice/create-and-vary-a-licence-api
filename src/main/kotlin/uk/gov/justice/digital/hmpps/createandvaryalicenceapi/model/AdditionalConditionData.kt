...
data class AdditionalConditionData(
  ...
  @field:Schema(description = "The value of this data item", example = "Norfolk")
  val value: String? = null,

  @field:Schema(description = "The sequence of this data item, for this condition on this licence", example = "1")
  val sequence: Int = -1,
