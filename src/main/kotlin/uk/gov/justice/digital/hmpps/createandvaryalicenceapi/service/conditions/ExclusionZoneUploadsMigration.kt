...
class ExclusionZoneUploadsMigration(
  ...
  private fun migrate(uploadDetail: AdditionalConditionUploadDetail) {
    ...
    }.onFailure { log.info("Unable to migrate AdditionalConditionUploadDetail id={}", uploadDetail.id) }
  }
  ...
  private fun migrate(uploadSummary: AdditionalConditionUploadSummary) {
    ...
    }.onFailure { log.info("Unable to migrate AdditionalConditionUploadSummary id={}", uploadSummary.id, it) }
  }
