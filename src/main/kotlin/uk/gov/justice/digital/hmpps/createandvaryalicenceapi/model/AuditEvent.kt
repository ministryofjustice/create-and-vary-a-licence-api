...
data class AuditEvent(
  @field:Schema(description = "The internal ID of the audit event", example = "1234")
  val id: Long? = null,
  ...
  @field:Schema(description = "The event type. One of SYSTEM_EVENT or USER_EVENT", example = "USER_EVENT")
  ...
  @field:Schema(description = "The changes that were made based on the action taken")
