...
data class ComReviewCount(
  ...
  @field:Schema(description = "A count of cases that the probation practitioner needs to review", example = "42")
  val myCount: Long,

  @field:Schema(description = "A list of teams, the probation practitioner is attached and the count of cases that need review")
