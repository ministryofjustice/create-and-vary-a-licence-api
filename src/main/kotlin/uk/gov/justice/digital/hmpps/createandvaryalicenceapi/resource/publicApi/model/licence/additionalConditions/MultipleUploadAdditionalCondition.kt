...
@JsonTypeName(ConditionTypes.MULTIPLE_UPLOADS)
@Schema(
  description = "Describes a multiple upload condition (restricted areas or other)",
)
data class MultipleUploadAdditionalCondition(
  ...
  @field:Schema(
    ...
    example = ConditionTypes.MULTIPLE_UPLOADS,
  )
  override val type: String = ConditionTypes.MULTIPLE_UPLOADS,
  ...
  @field:Schema(
    description = "Whether any image was uploaded",
    example = "true",
  )
