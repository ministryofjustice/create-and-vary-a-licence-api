...
@Schema(description = "Describes a time served licence that was created by a prison")
@JsonTypeName(LicenceKinds.TIME_SERVED)
data class TimeServedLicence(
  @field:Schema(
  ...
  @field:Schema(description = "The version number used for standard and additional conditions", example = "1.4")
  ...
  @field:Schema(description = "The prison booking number for the person on this licence", example = "F12333")
  ...
  @field:Schema(description = "The agency code of the detaining prison", example = "LEI")
  ...
  @field:Schema(description = "The telephone number to contact the prison", example = "0161 234 4747")
  override val prisonTelephone: String? = null,

  @field:Schema(description = "The first name of the person on licence", example = "Michael")
  override val forename: String? = null,

  @field:Schema(description = "The middle names of the person on licence", example = "John Peter")
  override val middleNames: String? = null,

  @field:Schema(description = "The family name of the person on licence", example = "Smith")
  override val surname: String? = null,

  @field:Schema(description = "The date of birth of the person on licence", example = "12/05/1987")
  @field:JsonFormat(pattern = "dd/MM/yyyy")
  override val dateOfBirth: LocalDate? = null,

  @field:Schema(description = "The earliest conditional release date of the person on licence", example = "13/08/2022")
  @field:JsonFormat(pattern = "dd/MM/yyyy")
  override val conditionalReleaseDate: LocalDate? = null,

  @field:Schema(description = "The actual release date (if set)", example = "13/09/2022")
  @field:JsonFormat(pattern = "dd/MM/yyyy")
  ...
  @field:Schema(description = "The nDELIUS staff identifier for the supervising probation officer", example = "12345")
  ...
  @field:Schema(description = "The full name of the supervising probation officer", example = "Jane Jones")
  ...
  @field:Schema(description = "The probation area code where this licence is supervised from", example = "N01")
  ...
  @field:Schema(description = "The team code that is supervising this licence", example = "Cardiff-A")
  ...
  // TODO may need to remove alongside hard stop due to deprecation
  ...
  @field:Schema(description = "If ARD||CRD falls on Friday/Bank holiday/Weekend then it contains Earliest possible release date or ARD||CRD")
  @field:JsonFormat(pattern = "dd/MM/yyyy")
  ...
  @field:Schema(description = "If a review of this licence is required", example = "true")
  override val isReviewNeeded: Boolean = reviewDate == null,

  @field:Schema(description = "The full name of the person who last submitted this licence", example = "Jane Jones")
  ...
  override val hardStopKind: LicenceKind? = null,
) : Licence
