...
class AddressSearchResource(private val addressSearchService: AddressSearchService) {
  ...
  fun searchForAddresses(@Size(min = 5, max = 100) @PathVariable(name = "searchQuery") searchQuery: String): List<AddressSearchResponse> = addressSearchService.searchForAddressesByText(searchQuery)
  ...
  fun searchForAddressesByPostcode(@Size(min = 5, max = 10) @PathVariable(name = "postcode") postcode: String): List<AddressSearchResponse> = addressSearchService.searchForAddressesByPostcode(postcode)
