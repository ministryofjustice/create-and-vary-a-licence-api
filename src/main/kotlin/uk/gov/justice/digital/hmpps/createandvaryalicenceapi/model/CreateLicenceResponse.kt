...
@Schema(description = "Response object for a created licence")
data class CreateLicenceResponse(
  ...
  @Schema(description = "The status of this new licence after creation", example = "IN_PROGRESS")
