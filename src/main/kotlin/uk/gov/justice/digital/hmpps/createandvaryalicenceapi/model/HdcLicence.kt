...
@JsonTypeName(LicenceKinds.HDC)
data class HdcLicence(
  @field:Schema(description = "Type of this licence", example = LicenceKinds.HDC, allowableValues = [LicenceKinds.HDC])
  override val kind: String = LicenceKinds.HDC,
  ...
  val weeklyCurfewTimes: List<HdcCurfewTimes>? = emptyList(),

  @field:Schema(description = "The first night curfew time for this licence")
  val firstNightCurfewTimes: HdcCurfewTimes? = null,
