...
data class HdcLicence(
  @Schema(description = "Type of this licence", example = LicenceKinds.HDC, allowableValues = [LicenceKinds.HDC])
  ...
  @Schema(description = "The curfew address for this licence", example = "1 Some Street, Some Town, SO30 2UH")
