...
data class AddAdditionalConditionRequest(
  @field:Schema(description = "Coded value for the additional condition", example = "meetingAddress")
  val conditionCode: String,

  @field:Schema(description = "Condition type, either AP or PSS", example = "AP")
