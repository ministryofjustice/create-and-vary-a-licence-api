...
fun toHardstop(
  ...
  probationTeamCode = licence.probationTeamCode,
  probationTeamDescription = licence.probationTeamDescription,
  appointmentPersonType = licence.contact?.personType,
  appointmentPerson = licence.contact?.person,
  appointmentTime = licence.contact?.time,
  appointmentTimeType = licence.contact?.timeType,
  appointmentAddress = licence.contact?.addressText,
  licenceAppointmentAddress = licence.contact?.address?.let { AddressMapper.toResponse(it) },
  appointmentContact = licence.contact?.telephoneContactNumber,
  appointmentTelephoneNumber = licence.contact?.telephoneContactNumber,
  appointmentAlternativeTelephoneNumber = licence.contact?.alternativeTelephoneContactNumber,
