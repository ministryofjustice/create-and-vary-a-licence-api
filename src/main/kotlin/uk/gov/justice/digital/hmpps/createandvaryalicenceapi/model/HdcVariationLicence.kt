...
data class HdcVariationLicence(
  @field:Schema(
    ...
    example = LicenceKinds.HDC_VARIATION,
    allowableValues = [LicenceKinds.HDC_VARIATION],
  )
  ...
  @field:Schema(description = "The licence Id which this licence is a variation of")
