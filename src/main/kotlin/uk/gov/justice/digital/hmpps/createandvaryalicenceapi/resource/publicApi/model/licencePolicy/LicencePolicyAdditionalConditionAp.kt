...
data class LicencePolicyAdditionalConditionAp(
  ...
  @Schema(description = "Indicates whether the condition requires electronic monitoring response", example = "true")
  val requiresElectronicMonitoringResponse: Boolean,
)
