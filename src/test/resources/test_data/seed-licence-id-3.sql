...
values (1, 3, 'std-1', 1, 'Be of generally good behaviour', 'AP');

insert into standard_condition (id, licence_id, condition_code, condition_sequence, condition_text, condition_type)
values (2, 3, 'std-2', 2, 'Do not break the law', 'AP');

insert into standard_condition (id, licence_id, condition_code, condition_sequence, condition_text, condition_type)
values (3, 3, 'std-3', 3, 'Attend meetings', 'AP');
...
values (1, 3, 'Freedom of movement', 'code-1', 1, 'Not to enter exclusion zone [EXCLUSION ZONE DESCRIPTION]', 'AP');
