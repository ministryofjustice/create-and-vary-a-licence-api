...
class PrisonerSearchApiClientTest {
  ...
  private fun stubPage(
    ...
    wiremock.stubFor(
      post("/prisoner-search/release-date-by-prison?size=$pageSize&page=$pageNumber&includeSupportedByPrisons=true")
        .willReturn(
