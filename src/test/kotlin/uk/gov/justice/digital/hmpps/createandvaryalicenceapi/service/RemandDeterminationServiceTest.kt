...
class RemandDeterminationServiceTest {
  ...
  private val resultCodes = listOf(
    "2507", "4001", "4004", "4012", "4016", "4505", "4506", "4531", "4532", "4534",
    "4535", "4536", "4537", "4539", "4549", "4553", "4554", "4560", "4561", "4563",
    "4564", "4565", "4570", "4571", "4588", "5601",
  )
  ...
  inner class GetRemandBookingIds {
    ...
    fun `returns the booking IDs of licences with a remand court outcome code`() {
      ...
      whenever(prisonApiClient.getCourtEventOutcomes(listOf(54321L, 54322L), resultCodes)).thenReturn(
        listOf(
  ...
  inner class IsRemandCase {
    ...
    @ValueSource(strings = ["2507", "4531", "5601"])
    fun `returns true for a remand court outcome code`(outcomeCode: String) {
      whenever(prisonApiClient.getCourtEventOutcomes(listOf(54322L), resultCodes)).thenReturn(
        listOf(CourtEventOutcome(bookingId = 54322L, eventId = 1L, outcomeReasonCode = outcomeCode)),
      )
    ...
    fun `returns false for a case with any other outcome code`() {
      whenever(prisonApiClient.getCourtEventOutcomes(listOf(54322L), resultCodes)).thenReturn(emptyList())
