...
class UpdateSentenceDatesNullConfigIntegrationTest : IntegrationTestBase() {
...
class UpdateSentenceDatesHardstopPolicyVersionIntegrationTest : IntegrationTestBase() {
