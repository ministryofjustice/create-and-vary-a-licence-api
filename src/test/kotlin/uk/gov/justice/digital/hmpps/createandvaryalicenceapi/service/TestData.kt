...
object TestData {
  ...
  fun aCvlRecord(nomsId: String = "A1234AA", licenceStartDate: LocalDate? = LocalDate.of(2021, 10, 22), kind: LicenceKind?, hardstopKind: HardstopKind? = HardstopKind.HARD_STOP) = CvlRecord(
    nomisId = nomsId,
