...
import uk.gov.justice.digital.hmpps.createandvaryalicenceapi.integration.wiremock.extensions.OAuthMockServer
...
@ExtendWith(OAuthMockServer::class, GovUkMockServer::class)
@ActiveProfiles("test")
@SpringBootTest(
