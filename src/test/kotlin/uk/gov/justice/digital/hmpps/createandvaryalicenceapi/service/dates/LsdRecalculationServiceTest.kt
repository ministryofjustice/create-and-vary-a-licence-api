    ...
    assertThat(auditCaptor.allValues[0]).extracting("detail", "summary")
      .isEqualTo(
        listOf(
          ...
          "Licence Start Date recalculated from 2021-10-20 to 2021-10-22 for Bob Bloggs",
        ),
      )
    assertThat(auditCaptor.allValues[1]).extracting("detail", "summary")
      .isEqualTo(
        listOf(
          ...
          "Licence Start Date recalculated from 2021-10-23 to 2021-10-22 for Bob Bloggs",
        ),
      )
  }
